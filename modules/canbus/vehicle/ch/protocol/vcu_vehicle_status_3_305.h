...
class Vcuvehiclestatus3305 : public ::apollo::drivers::canbus::ProtocolData<
                    ::apollo::canbus::ChassisDetail> {
 public:
  static const int32_t ID;
  Vcuvehiclestatus3305();
 ...
 private:
  ...
  double rpm_rr_rpt(const std::uint8_t* bytes, const int32_t length) const;
  ...
  double rpm_rl_rpt(const std::uint8_t* bytes, const int32_t length) const;
  ...
  double rpm_fr_rpt(const std::uint8_t* bytes, const int32_t length) const;
  ...
  double rpm_fl_rpt(const std::uint8_t* bytes, const int32_t length) const;
};
