...
void Mcurldrivemotorfeedbackmsg80::Parse(const std::uint8_t* bytes, int32_t length,
  ...
  chassis->mutable_ch()->mutable_mcurl_drive_motor_feedback_msg_80()->set_rl_reserved_1(rl_reserved_1(bytes, length));
  chassis->mutable_ch()->mutable_mcurl_drive_motor_feedback_msg_80()->set_rl_mcu_motor_error_grade(rl_mcu_motor_error_grade(bytes, length));
  chassis->mutable_ch()->mutable_mcurl_drive_motor_feedback_msg_80()->set_rl_energy_recovery_state(rl_energy_recovery_state(bytes, length));
  chassis->mutable_ch()->mutable_mcurl_drive_motor_feedback_msg_80()->set_rl_controltemp(rl_controltemp(bytes, length));
  chassis->mutable_ch()->mutable_mcurl_drive_motor_feedback_msg_80()->set_rl_idc(rl_idc(bytes, length));
  chassis->mutable_ch()->mutable_mcurl_drive_motor_feedback_msg_80()->set_rl_udc(rl_udc(bytes, length));
}
