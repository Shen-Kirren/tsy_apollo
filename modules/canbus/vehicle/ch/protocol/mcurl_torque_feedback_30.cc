...
void Mcurltorquefeedback30::Parse(const std::uint8_t* bytes, int32_t length,
  ...
  chassis->mutable_ch()->mutable_mcurl_torque_feedback_30()->set_rl_torque(rl_torque(bytes, length));
  chassis->mutable_ch()->mutable_mcurl_torque_feedback_30()->set_rl_speed(rl_speed(bytes, length));
  chassis->mutable_ch()->mutable_mcurl_torque_feedback_30()->set_rl_shift(rl_shift(bytes, length));
  chassis->mutable_ch()->mutable_mcurl_torque_feedback_30()->set_rl_motortemp(rl_motortemp(bytes, length));
  chassis->mutable_ch()->mutable_mcurl_torque_feedback_30()->set_rl_errorcode(rl_errorcode(bytes, length));
  chassis->mutable_ch()->mutable_mcurl_torque_feedback_30()->set_rl_current(rl_current(bytes, length));
}
