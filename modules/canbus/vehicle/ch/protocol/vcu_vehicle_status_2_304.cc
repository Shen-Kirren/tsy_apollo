...
void Vcuvehiclestatus2304::Parse(const std::uint8_t* bytes, int32_t length,
  ...
  chassis->mutable_ch()->mutable_vcu_vehicle_status_2_304()->set_throttle_rpt(throttle_rpt(bytes, length));
  chassis->mutable_ch()->mutable_vcu_vehicle_status_2_304()->set_r_tire_angle(r_tire_angle(bytes, length));
  chassis->mutable_ch()->mutable_vcu_vehicle_status_2_304()->set_f_tire_angle(f_tire_angle(bytes, length));
  chassis->mutable_ch()->mutable_vcu_vehicle_status_2_304()->set_vehicle_brake_pressure(vehicle_brake_pressure(bytes, length));
  chassis->mutable_ch()->mutable_vcu_vehicle_status_2_304()->set_vehicle_speed(vehicle_speed(bytes, length));
}
