...
class Mcufrtorquefeedback20 : public ::apollo::drivers::canbus::ProtocolData<
                    ::apollo::canbus::ChassisDetail> {
 public:
  static const int32_t ID;
  Mcufrtorquefeedback20();
 ...
 private:
  ...
  double fr_torque(const std::uint8_t* bytes, const int32_t length) const;
  ...
  double fr_speed(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int fr_shift(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int fr_motortemp(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int fr_errorcode(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int fr_current(const std::uint8_t* bytes, const int32_t length) const;
};
