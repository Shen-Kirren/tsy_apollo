...
void Vcuvehiclestatus1303::Parse(const std::uint8_t* bytes, int32_t length,
  ...
  chassis->mutable_devkit()->mutable_vcu_vehicle_status_1_303()->set_vehicle_status_reserved(vehicle_status_reserved(bytes, length));
  chassis->mutable_devkit()->mutable_vcu_vehicle_status_1_303()->set_bms_status(bms_status(bytes, length));
  chassis->mutable_devkit()->mutable_vcu_vehicle_status_1_303()->set_ignitionstatus(ignitionstatus(bytes, length));
  chassis->mutable_devkit()->mutable_vcu_vehicle_status_1_303()->set_gear_rpt(gear_rpt(bytes, length));
  chassis->mutable_devkit()->mutable_vcu_vehicle_status_1_303()->set_epb_rpt(epb_rpt(bytes, length));
  chassis->mutable_devkit()->mutable_vcu_vehicle_status_1_303()->set_vcu_ready_flag(vcu_ready_flag(bytes, length));
}
