...
void Mcufrtorquefeedback20::Parse(const std::uint8_t* bytes, int32_t length,
  ...
  chassis->mutable_devkit()->mutable_mcufr_torque_feedback_20()->set_fr_torque(fr_torque(bytes, length));
  chassis->mutable_devkit()->mutable_mcufr_torque_feedback_20()->set_fr_speed(fr_speed(bytes, length));
  chassis->mutable_devkit()->mutable_mcufr_torque_feedback_20()->set_fr_shift(fr_shift(bytes, length));
  chassis->mutable_devkit()->mutable_mcufr_torque_feedback_20()->set_fr_motortemp(fr_motortemp(bytes, length));
  chassis->mutable_devkit()->mutable_mcufr_torque_feedback_20()->set_fr_errorcode(fr_errorcode(bytes, length));
  chassis->mutable_devkit()->mutable_mcufr_torque_feedback_20()->set_fr_current(fr_current(bytes, length));
}
