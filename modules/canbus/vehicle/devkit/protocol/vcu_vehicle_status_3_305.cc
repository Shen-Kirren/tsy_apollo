...
void Vcuvehiclestatus3305::Parse(const std::uint8_t* bytes, int32_t length,
  ...
  chassis->mutable_devkit()->mutable_vcu_vehicle_status_3_305()->set_rpm_rr_rpt(rpm_rr_rpt(bytes, length));
  chassis->mutable_devkit()->mutable_vcu_vehicle_status_3_305()->set_rpm_rl_rpt(rpm_rl_rpt(bytes, length));
  chassis->mutable_devkit()->mutable_vcu_vehicle_status_3_305()->set_rpm_fr_rpt(rpm_fr_rpt(bytes, length));
  chassis->mutable_devkit()->mutable_vcu_vehicle_status_3_305()->set_rpm_fl_rpt(rpm_fl_rpt(bytes, length));
}
