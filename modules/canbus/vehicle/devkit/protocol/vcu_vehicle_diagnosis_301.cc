...
void Vcuvehiclediagnosis301::Parse(const std::uint8_t* bytes, int32_t length,
  ...
  chassis->mutable_devkit()->mutable_vcu_vehicle_diagnosis_301()->set_vehicle_diagnosis_reserved_3(vehicle_diagnosis_reserved_3(bytes, length));
  chassis->mutable_devkit()->mutable_vcu_vehicle_diagnosis_301()->set_vehicle_diagnosis_reserved_1(vehicle_diagnosis_reserved_1(bytes, length));
  chassis->mutable_devkit()->mutable_vcu_vehicle_diagnosis_301()->set_vehicle_diagnosis_reserved_2(vehicle_diagnosis_reserved_2(bytes, length));
  chassis->mutable_devkit()->mutable_vcu_vehicle_diagnosis_301()->set_epb_state(epb_state(bytes, length));
  chassis->mutable_devkit()->mutable_vcu_vehicle_diagnosis_301()->set_vehicle_fault_grade(vehicle_fault_grade(bytes, length));
  chassis->mutable_devkit()->mutable_vcu_vehicle_diagnosis_301()->set_r_attach_switch_state(r_attach_switch_state(bytes, length));
  chassis->mutable_devkit()->mutable_vcu_vehicle_diagnosis_301()->set_f_attach_switch_state(f_attach_switch_state(bytes, length));
  chassis->mutable_devkit()->mutable_vcu_vehicle_diagnosis_301()->set_bms_state(bms_state(bytes, length));
  chassis->mutable_devkit()->mutable_vcu_vehicle_diagnosis_301()->set_iecu_state(iecu_state(bytes, length));
  chassis->mutable_devkit()->mutable_vcu_vehicle_diagnosis_301()->set_dbsr_state(dbsr_state(bytes, length));
  chassis->mutable_devkit()->mutable_vcu_vehicle_diagnosis_301()->set_rlmotor_state(rlmotor_state(bytes, length));
  chassis->mutable_devkit()->mutable_vcu_vehicle_diagnosis_301()->set_rrmotor_state(rrmotor_state(bytes, length));
  chassis->mutable_devkit()->mutable_vcu_vehicle_diagnosis_301()->set_flmotor_state(flmotor_state(bytes, length));
  chassis->mutable_devkit()->mutable_vcu_vehicle_diagnosis_301()->set_frmotor_state(frmotor_state(bytes, length));
  chassis->mutable_devkit()->mutable_vcu_vehicle_diagnosis_301()->set_rsteering_state(rsteering_state(bytes, length));
  chassis->mutable_devkit()->mutable_vcu_vehicle_diagnosis_301()->set_fsteering_state(fsteering_state(bytes, length));
  chassis->mutable_devkit()->mutable_vcu_vehicle_diagnosis_301()->set_dbsf_state(dbsf_state(bytes, length));
  chassis->mutable_devkit()->mutable_vcu_vehicle_diagnosis_301()->set_remote_state(remote_state(bytes, length));
  chassis->mutable_devkit()->mutable_vcu_vehicle_diagnosis_301()->set_emergency_button_state(emergency_button_state(bytes, length));
}
