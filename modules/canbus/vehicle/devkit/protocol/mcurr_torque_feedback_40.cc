...
void Mcurrtorquefeedback40::Parse(const std::uint8_t* bytes, int32_t length,
  ...
  chassis->mutable_devkit()->mutable_mcurr_torque_feedback_40()->set_rr_torque(rr_torque(bytes, length));
  chassis->mutable_devkit()->mutable_mcurr_torque_feedback_40()->set_rr_speed(rr_speed(bytes, length));
  chassis->mutable_devkit()->mutable_mcurr_torque_feedback_40()->set_rr_shift(rr_shift(bytes, length));
  chassis->mutable_devkit()->mutable_mcurr_torque_feedback_40()->set_rr_motortemp(rr_motortemp(bytes, length));
  chassis->mutable_devkit()->mutable_mcurr_torque_feedback_40()->set_rr_errorcode(rr_errorcode(bytes, length));
  chassis->mutable_devkit()->mutable_mcurr_torque_feedback_40()->set_rr_current(rr_current(bytes, length));
}
