...
void Mcufltorquefeedback10::Parse(const std::uint8_t* bytes, int32_t length,
  ...
  chassis->mutable_devkit()->mutable_mcufl_torque_feedback_10()->set_fl_errorcode(fl_errorcode(bytes, length));
  chassis->mutable_devkit()->mutable_mcufl_torque_feedback_10()->set_fl_motortemp(fl_motortemp(bytes, length));
  chassis->mutable_devkit()->mutable_mcufl_torque_feedback_10()->set_fl_current(fl_current(bytes, length));
  chassis->mutable_devkit()->mutable_mcufl_torque_feedback_10()->set_fl_torque(fl_torque(bytes, length));
  chassis->mutable_devkit()->mutable_mcufl_torque_feedback_10()->set_fl_speed(fl_speed(bytes, length));
  chassis->mutable_devkit()->mutable_mcufl_torque_feedback_10()->set_fl_shift(fl_shift(bytes, length));
