...
class Mcurrtorquefeedback40 : public ::apollo::drivers::canbus::ProtocolData<
                    ::apollo::canbus::ChassisDetail> {
 public:
  static const int32_t ID;
  Mcurrtorquefeedback40();
 ...
 private:
  ...
  double rr_torque(const std::uint8_t* bytes, const int32_t length) const;
  ...
  double rr_speed(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int rr_shift(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int rr_motortemp(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int rr_errorcode(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int rr_current(const std::uint8_t* bytes, const int32_t length) const;
};
